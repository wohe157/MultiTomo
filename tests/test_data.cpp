...
TEST_F(DataTest, MultiplicationOperatorWithData) {
    mt::Data rhs(2, 3, 2, { 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 1.0f });
    mt::Data result = f_Data1 * rhs;
    f_Data1 *= rhs;
